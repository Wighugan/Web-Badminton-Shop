...
<li>
        ...
        <div class="main">
            ...
            <div class="addproduct">
                ...
                <form action="updateuser.php?type=nhacungcap"method="POST" enctype="multipart/form-data">                   
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="fullname" value="<?= $nhacungcap['fullname'] ?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="numberphone" name="numberphone" value="<?= $nhacungcap['numberphone'] ?>" required>
                        
                    </div>

                    <div class="form-group">
                        <label for="email">Ngày hợp tác:</label>
                        <input type="date" id="birthday" name="NgayHopTac" value="<?= $nhacungcap['NgayHopTac'] ?>" required>
                        </div>


                    <div class="form-group">
                        <label for="email">Người đại diện:</label>
                        <input type="text" id="NguoiDaiDien" name="NguoiDaiDien" value="<?= $nhacungcap['NguoiDaiDien'] ?>" required>
                        </div>
