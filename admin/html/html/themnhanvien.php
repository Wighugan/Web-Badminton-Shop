    ...
    if (file) {
        ...
        reader.readAsDataURL(file); // Đọc file dưới dạng URL
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="birthday" name="daywork" onfocus="(this.type='date')" onblur="(this.type= this.value ? 'date' : 'text')" >
                    </div>
 

                    <div class="form-group">
                        <label for="email">Ngày Sinh:</label>
                        <input type="date" id="birthday" name="birthday" onfocus="(this.type='date')" onblur="(this.type= this.value ? 'date' : 'text')" >
                    </div>
