...
// ===== BƯỚC 1: Đếm tổng số chi tiết phiếu nhập =====
$data = new Database();
$sql_total = "SELECT COUNT(*) AS total FROM chitietphieunhap";
$data->select($sql_total);
$row_total = $data->fetch();
$total_rows = $row_total['total'] ?? 0;
$total_pages = ceil($total_rows / $limit);

// ===== BƯỚC 2: Lấy dữ liệu chi tiết phiếu nhập (JOIN với product nếu cần) =====
$data = new Database();

// Nếu bạn chỉ muốn lấy dữ liệu từ bảng chitietphieunhap:
...
// ===== BƯỚC 3: Lấy toàn bộ kết quả =====
$chitiet = $data->fetchAll();
