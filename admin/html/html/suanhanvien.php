...
<li>
        ...
        <div class="main">
            ...
            <div class="addproduct">
                ...
                <form action="updateuser.php?type=nhanvien" method="POST" enctype="multipart/form-data">                   
                <input type="hidden" name="id" value="<?= $nhanvien['id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?= $nhanvien['username'] ?>" required>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" value="<?= $nhanvien['fullname'] ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="numberphone" name="numberphone" value="<?= $nhanvien['numberphone'] ?>" required>
                        
                    </div>

                    <div class="form-group">
                        <label for="email">Ngày vào làm:</label>
                        <input type="text" id="daywork" name="daywork" value="<?= $nhanvien['daywork'] ?>" required>
                        </div>


                    <div class="form-group">
                        <label for="email">Ngày Sinh:</label>
                        <input type="date" id="birthday" name="birthday" value="<?= $nhanvien['birthday'] ?>" required>
                        </div>
