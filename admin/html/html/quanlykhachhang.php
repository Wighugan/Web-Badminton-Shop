...
// Nút khóa / mở khóa
if ($row['status'] == 1) {
    echo "<a href='#' onclick='lock_user({$row['id']}, \"users\")' class='btn btn-sm btn-danger' style='color: red' title='Khóa tài khoản'>";
    echo "<i class='fa-solid fa-lock'></i> Khóa";
    echo "</a>";
} else {
    echo "<a href='#' onclick='unlock_user({$row['id']}, \"users\")' class='btn btn-sm btn-success'style='color: green' title='Mở khóa tài khoản'>";
    echo "<i class='fa-solid fa-lock-open'></i> Mở khóa";
    echo "</a>";
}
